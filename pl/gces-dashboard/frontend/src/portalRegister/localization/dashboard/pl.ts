export const dashboardPL: LanguageKeyValueMap = {
  ...
  'requestFullScreen!name': 'Pokaz slajdów',
  'requestFullScreen!description': 'Pokaz slajdów',
  'caching!name': 'bufor',
  allowCachingSetting: 'Zezwól na buforowanie',
  allowCachingSettingNo: 'nie',
  ...
  cachingIntervalWeek: 'tydzień',
  cachingIntervalMonth: 'miesiąc',
