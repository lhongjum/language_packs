export const incrementalUpdateCotPL = {
	...
	IncrementalUpdateDataSet: 'Zestaw danych aktualizacji przyrostowej', // Incremental Update Dataset
	IncrementalUpdating: 'Aktualizuję', // Updating
	IncrementalUpdateComplete: 'Aktualizacja przyrostowa zakończona', // Incremental Update Complete
	NoNeedIncrementalUpdate: 'Nie ma potrzeby przyrostowej aktualizacji tego zbioru danych.', // No need to incremental update this dataset.
	IncrementalUpdateDatasetFailed: 'Przyrostowa aktualizacja zestawu danych nie powiodła się', // Incremental Update dataset failed
	IncrementalUpdateDatasetConfirmMsg: 'Czy chcesz przyrostowo aktualizować bieżącą pamięć podręczną zestawu danych?', // Do you want to incremental update the current dataset cache?
