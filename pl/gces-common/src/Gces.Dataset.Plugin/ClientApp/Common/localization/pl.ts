export const gcExceptionLocalePL = {
	...
	E_70002: '401 Błąd Autoryzacji. Żądanie nie zostało zastosowane, ponieważ nie ma ważnych danych uwierzytelniających dla zasobu docelowego.', // 401 Unauthorized Error. The request has not been applied because it lacks valid authentication credentials for the target resource.
	...
	E_70008: '500 Wewnętrzny błąd serwera. Serwer napotkał nieoczekiwany warunek, który uniemożliwił mu realizację żądania..', // 500 Internal Server Error. The server encountered an unexpected condition that prevented it from fulfilling the request.
	...
	E_90005: 'Oczekiwanie wyrażenia literału.', // Expecting literal expression.
	...
	E_80066: 'Funkcja zwracająca tabelę wymaga nazwy tabeli aliasów.', // Table-valued function requires an alias table name.
	...
	E_80068: 'Klauzula With nie jest obsługiwana przez funkcję zwracającą tabelę.', // With-clause not supported by table-valued function.
	E_80069: 'Klauzula With jest wymagana przez funkcję zwracającą tabelę.', // With-clause is required by table-valued function.
	E_80070: 'CROSS APPLY lub OUTER APPLY wymagane przez funkcję zwracającą tabelę.', // CROSS APPLY or OUTER APPLY required by table-valued function.
	E_80071: 'CROSS APPLY i OUTER APPLY nie wymagają żadnych ograniczeń.', // CROSS APPLY and OUTER APPLY require no constraints.
	E_80072: 'Nieobsługiwany typ danych kolumny w klauzuli WITH.', // Unsupported data type of column in with-clause.
	E_80073: 'Nieprawidłowe parametry funkcji zwracającą tabelę.', // Invalid table-valued function parameters.
	E_80074: 'Jako pierwsza wybrana tabela, funkcja zwracającą tabelę nie może akceptować odwołań do kolumn jako parametrów.', // As the first table being selected a table-valued function can not accept column references as parameters.
	E_80075: 'Funkcja zwracająca tabelę może mieć tylko jeden podpis.', // A table-valued function can have only one signature.
	E_80076: 'Naruszone aliasy tabel.', // Aliases of tables vialated.
	E_80077: 'Jawny schemat WITH wymagany przez funkcję zwracającą tabelę.', // Explicit WITH schema required by table-valued function.
	E_80078: 'Jawnego schematu WITH nie można używać razem z funkcją zwracającą tabelę.', // Explicit WITH schema can not be used together with table-valued function.
	E_80079: 'Funkcja zwracająca tabelę jest niezdefiniowana.', // Table-valued function is undefined.
	E_80080: 'Miesiąc rozpoczęcia roku podatkowego jest nieprawidłowy.', // Start month of fiscal year is invalid.
	E_60053: 'PreQuery musi używać parametru @source.', // PreQuery must use @source parameter.
