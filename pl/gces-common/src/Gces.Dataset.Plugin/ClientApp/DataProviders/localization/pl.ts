...
export const datasetPL: LanguageKeyValueMap = {
	...
	CheckedConfirmTip: 'Niedostępny dostawca danych', // Unavailable Data Provider
	CheckedConfirmText: 'Sterownik {{providerName}} nie jest zainstalowany. Aby go zainstalować, wykonaj czynności opisane w dokumentacji.', // The {{providerName}} Driver is not installed, please follow the steps in Documentation to install it.
	MultiCheckedConfirmText: 'Sterowniki {{providerName}} nie są zainstalowane. Aby je zainstalować, wykonaj czynności opisane w dokumentacji.', // The {{providerName}} Drivers are not installed, please follow the steps in Documentation to install them.
	Search: 'Szukaj', // Search
	Close: 'Zamknij', // Close

	AllDataProviders: 'Wszyscy dostawcy danych', // All Data Providers
	DisableAllBetaDataProviders: 'Wyłącz wszystkich dostawców danych w wersji beta', // Disable All Beta Data Providers
