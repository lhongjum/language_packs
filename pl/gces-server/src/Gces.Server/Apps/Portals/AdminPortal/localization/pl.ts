export const portalPL: LanguageKeyValueMap = {
	...
	'shortcut-appearance!description': '',
	'shortcut-appearance!props!text': 'Appearance',
	'shortcut-appearance!title': 'Appearance Shortcut',
	...
	'wyn-plugin-monitor!title': 'Services', // Services
	...
	'shortcut-smtp!description': '',
	'shortcut-smtp!props!text': 'Wiadomości email', // Email Settings
	'shortcut-smtp!title': 'Skrót do Wiadomości email', // Email Settings Shortcut
	...
	'LinksInfo!title': 'Links', // Links
	'LinksInfo!description': 'Links', // Links
	...
	'colorPropertyEditor_saturation': 'Saturation',
