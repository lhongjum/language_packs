...
export const designerResourcePL: LanguageKeyValueMap = {
	...
	actionBar_importImage: 'Importuj obraz', // Import Image
	actionBar_path: 'Ścieżka', // Path
	actionBar_rect: 'Prostokąt', // Rectangle
	actionBar_ellipsis: 'Elipsa', // Ellipsis
	actionBar_zoomIn: 'Przybliżenie', // ZoomIn
	actionBar_zoomOut: 'Oddalenie', // ZoomOut
	actionBar_name: 'Nazwa', // Name
	menuItem_rename: 'Zmień nazwę', // Rename
	menuItem_delete: 'Usuń', // Delete
	menuItem_delete_shortCut: 'BACKSPACE',
	menuItem_group: 'Grupuj', // Group
	menuItem_group_shortCut: 'G',
	menuItem_unGroup: 'Rozgrupuj', // Ungroup
	...
	err_300003: 'Brak dostępu.', // Access denied.
	err_300004: 'Wykryto nieprawidłowy parametr.', // Invalid parameter detected.
	err_300005: 'Dokument został usunięty.', // Document was removed.
	err_300006: 'Nie znaleziono dokumentu.', // Document not found.
