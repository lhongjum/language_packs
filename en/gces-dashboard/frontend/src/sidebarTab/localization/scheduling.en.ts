export const schedulingEN: LanguageKeyValueMap = {
	...
	securityErr_10004_1: '[Security Error] The organization where the task was created does not exist.',
	...
	taskErr_30010: 'Data source <{docEnv.Value.Title}> is unable to append data.',
	...
	sagaTextSuccessMessageVerifyLocation: 'The Location input is valid',
	...
	'dashboardScheduleTasks!name': 'Tasks',
	'dashboardScheduleTasks!description': 'Scheduled tasks for the document',

	'dashboardScheduleHistory!name': 'History',
	'dashboardScheduleHistory!description': 'Scheduled task execution history',
