export const datasetEN = {
	...
	DatasourceUnavailable: 'The datasource driver is not installed, please follow the document to install and use.',
	DatasourceUnavailableEditHint: 'Error hint: the datasource driver is not installed, could not edit this datasource.',
	...
	ColumnNameAlreadyExists: 'The column name "{{name}}" already exists',
	...
	AuthEmptyTip: 'This request does not use any authorization.',
	...
	UpdateDatasourceSuccess: 'Update Data Source successfully',
	...
	// json datasource
	DataSourceHeaderKey: 'Header Key',
	DataSourceHeaderValue: 'Header Value',
	Header: 'Request Headers',
	EndpointHeaders: 'Endpoint Headers',
	EditbaseURIItem: 'Edit Base Address',
	DataSourceHeaderAdd: 'Add Header',
	Authorization: 'Authorization',
	AddEndpoint: 'Add Endpoint',
	AddBaseURIItem: 'Add Base Address',
	EditEndpoint: 'Edit Enpoint',
	RawType: 'Raw Content Type',
	PayloadParameter: 'Payload Parameter',
	AuthCanNotBeDelete: 'Authorization "{{auth}}" cannot be delete because it is used by the following endpoints: \n{{endpoints}}.',
	EditAuthItem: 'Edit Authorization',
	AddAuthItem: 'Add Authorization',
	PayloadWarningWithEndpoint: 'The content-type from payload is different from the content-type value from the header of the current endpoint.',
	PayloadWarningWithWebConfig: 'The content-type from payload is different from the content-type value from datasource request header.',
	HeaderKeyIsContentType: 'Content-Type can only be generated by the payload setting.',
	HeaderKeyCanNotEmpty: 'Request Header key cannot be empty.',
	HeaderAlreadyExistsError: 'Request Header "{{headerKey}}" key already exists.',
	PreviewEndpoint: 'Data Preview',
	Validate: 'Validate',
	validateStatus: 'Validated',
	success: 'Yes',
	failed: 'Failed',
	'not-validate': 'No',
	validateSuccess: 'Validate successfully',
	validateSuccessDetail: 'Endpoint "{{endpointName}}" validate successfully',
	...
	err_10018: 'In \'Cached Dataset\' mode,CustomSql can not reference an {{context}} parameter "{{referredParameter}}".',
	err_10019: 'In \'Cached Dataset\' mode,Calculated field "{{calculatedField}}" can not reference an {{context}} parameter "{{referredParameter}}".',
	err_10020: 'In \'Cached Dataset\' mode,Sql expression "{{sqlExpression}}" on table "{{table}}" can\'t reference an {{context}} parameter "{{referredParameter}}".',
	...
	err_21001: 'Invalid datasource document id.',
	...
	err_100027: 'The datasource mapping file is invalid',
	err_100028: 'The datasource mapping file contains invalid table name.',
	err_100029: 'The datasource mapping file contains invalid column name.',
	...
	err_100031: 'Get mapping template file failed.',
	...
	'err_5002': 'The provider and the connection string do not match.',
	'err_5003': 'Test connection failed. Please check the connection string.\nErrorMessage:\n{{errorMessage}}',
	...
	'User ID': 'User',
	Pwd: 'Password',
	'ServerPort(eg localhost39013))': 'Server:Port(e.g. localhost:39013)',
	ALIAnalyticDBMySql: 'AnalyticDB for MySQL',

	// mapping
	UseMappingConfig: 'Use Table/Field Name Mapping',
	TableFieldNameMapping: 'Table/Field Name Mapping',
	Mapping: 'Mapping',
	MappingTables: 'Tables',
	MappingColumns: 'Columns',
	LoadFromFile: 'Load From File',
	OriginalName: 'Original Name',
	DisplayName: 'New Name',
	DownloadMappingTemplateFile: 'Download Template File',
	MappingWarning: 'Data Source configuration changed, Mapping may invalid.',
	TableNameIsInvalid: 'Invalid table name. please do not use restricted symbols < > \\ : ? * / | \ " [ ], only single .(dot) can be used and do not use . (dot) as the first symbol in the table name.',
	SchemaNotFound: 'No valid schema definition found in datasource connection string.',
