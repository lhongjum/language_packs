export const portalDataEN: LanguageKeyValueMap = {
	...
	revertError: 'Model revert failed',
	...
	dlReportDataModel: 'Sematic Model',
	dlDashboardDataModel: 'Cached Model',
	dlDirectQueryModel: 'Direct Query Model',
