export const localeEn = {
  ...
  chartTypes: {
    ...
    scatter: 'Scatter',
    aggregatedScatter: 'Aggregated Scatter',
    bubble: 'Bubble Chart',
    ...
    categories: {
      charts: {
        ...
        groups: {
          ...
          tables: 'Tables',
          maps: 'Maps',
          spreadCharts: 'Calc Charts',
          mergedCharts: 'Multi-source Charts',
        },
      },
      components: {
        title: 'Components',
  ...
  dataBindingPanel: {
    ...
    addAccountingCalculation: 'Accounting Calculation',
    ...
    groupAccounting: 'Group Accounting',
  ...
  inspector: {
    ...
    properties: {
      ...
      charts: {
        ...
        showEmptyStringItems: 'Show Empty String',
      ...
      tables: {
        ...
        enableUiFilter: 'Enable Ui Filter In Run Time',
      },
      slicers: {
        selectionMode: {
  ...
  spreadChart: {
    enterEditing: 'Edit Custom Dataset',
    exitEditing: 'Exit Editor',
    bindingHint: 'Please click the "Edit" button to generate a dataset.',
  ...
  error: {
    ...
    errorCode: {
      ...
      200002: {
        ...
        content: 'Cannot find the {{type}} document \'{{name}}\'.',
      },
      200101: {
