export const datasourceSchedulingES: LanguageKeyValueMap = {
	...
	taskEditorLabelMailTooltip: 'Send the failure message to the specified mailbox when the task execution failed',
	taskEditorLabelFolderLocation: 'Folder Location',
	taskEditorLabelFolderLocationToolTip: 'Please ensure that Read and Write permissions are given for the specified folder location',
	locationPlaceholder: 'Please input the folder location',
	taskEditorLabelAction: 'Action',
